...
def process_data():
    ...
    print("0-6 " + str(amount1) + " positive1 " + str(positive1) + " negative1 " + str(
        negative1) + " neutral1 " + str(neutral1))
    print("6-12 " + str(amount2) + " positive2 " + str(positive2) + " negative2 " + str(
        negative2) + " neutral2 " + str(neutral2))
    print("12-18 " + str(amount3) + " positive3 " + str(positive3) + " negative3 " + str(
        negative3) + " neutral3 " + str(neutral3))
    print("18-24 " + str(amount4) + " positive4 " + str(positive4) + " negative4 " + str(
        negative4) + " neutral4 " + str(neutral4))
